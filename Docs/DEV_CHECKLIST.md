...
| 13 — Khatm + azkar + adhan polish | 8 | 6 | ~75% | khatm engine + azkar seed + adhan wrapper all done. **Pending:** family-private weekly leaderboard, full azkar dataset hydration. |
