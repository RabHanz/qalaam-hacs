...
| 17 — QUL deep ingestion (v0.5 → v2.0)                | 22    | 22   | **100%** | License-aware framework + **all 7 sub-reader scaffolds** + ingest framework + **all 5 ingest scripts** + inventory doc + ADR-0020 + **all 6 backend routes** + **UI consumption** (LayoutSwitcher in /read, WordByWordPane + MutashabihatWatchlistPane in /study, MutashabihatWatchlistPane in /hifdh). 17 sub-reader tests + 12 backend route tests pass. Web typecheck clean. **Ingest scripts** await QUL source bytes per ADR-0020 manual one-shot fetch.                                                                                                                                                                                                                                                                                                                                                                                                                                          |
