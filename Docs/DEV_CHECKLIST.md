...
| 3-pane deep-study view                                          | `/study/[surah]/[ayah]` ships hero verse + 5 panes (translations / WBW / **NEW grammar** / tafsir / mutashabihat sidebar). Asbab al-nuzul still empty (data exists in `qalaam_v1_qul_surah_info.asbab_al_nuzul`; pane wiring pending). | 〰️ |
