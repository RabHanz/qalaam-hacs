"""Qalaam calendar entity — review schedule (FSRS-6 due dates surfaced on the HA calendar)."""
...
async def async_setup_entry(
    ...
    async_add_entities([QalaamReviewCalendar(coordinator)])


class QalaamReviewCalendar(QalaamEntity, CalendarEntity):
