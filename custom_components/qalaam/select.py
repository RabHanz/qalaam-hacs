"""Qalaam select entities — reciter + mushaf."""
...
async def async_setup_entry(
    ...
    async_add_entities(
        [
            QalaamReciterSelect(coordinator),
            QalaamMushafSelect(coordinator),
        ]
    )


class QalaamReciterSelect(QalaamEntity, SelectEntity):
...
class QalaamMushafSelect(QalaamEntity, SelectEntity):
